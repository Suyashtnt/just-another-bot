		...
		plugin = (() => {
			var e = {
								...
								hooks: {
									afterWorkspaceDependencyAddition: async (e, t, r, o) => {
										...
										const g = `${a.suggestUtils.Modifier.CARET}${y.major}`,
											...
											f = s.miscUtils.mapAndFind(i.workspaces, (e) => {
												...
												const o =
													...
													n =
														null ===
															(a = e.manifest.devDependencies.get(r.identHash)) ||
														void 0 === a
															? void 0
															: a.descriptorHash;
										...
										if (void 0 !== f)
											...
											try {
												if (0 === (await u.getCandidates(b, new Map(), p)).length)
													return;
											} catch (e) {
												return;
											}
					...
					469: (e, t, r) => {
						...
						r.r(t),
							r.d(t, { createFallbackableCache: () => s, createNullCache: () => a });
					},
					712: (e, t, r) => {
						'use strict';
						function s(e = { serializable: !0 }) {
							...
							return {
								...
								set: (r, s) => (
									(t[JSON.stringify(r)] = e.serializable ? JSON.stringify(s) : s),
									Promise.resolve(s)
								),
					...
					223: (e, t, r) => {
						...
						const n = (e) => {
							...
							c = (e) => (t, r) =>
								e.transporter.write(
									{ method: o.N.Delete, path: (0, s.encode)('2/abtests/%s', t) },
									r,
								),
							d = (e) => (t, r) =>
								e.transporter.read(
							...
							u = (e) => (t, r) =>
								e.transporter.write(
									{ method: o.N.Post, path: (0, s.encode)('2/abtests/%s/stop', t) },
									r,
								);
					},
					757: (e, t, r) => {
						...
						const p = (e) => (t, r) => {
								...
								return (
									...
									(0, s.createWaitablePromise)(
										e.transporter.write(
											{
												method: o.N.Post,
												path: (0, s.encode)('1/indexes/%s/rules/clear', e.indexName),
											},
											i,
										),
										(t, r) => De(e)(t.taskID, r),
							...
							J = (e) => (t, r) =>
								(0, s.createWaitablePromise)(
									e.transporter.write(
										{
											method: o.N.Post,
											path: (0, s.encode)('1/indexes/%s/deleteByQuery', e.indexName),
											data: t,
										},
										r,
									),
							...
							ce = (e) => (t, r) =>
								e.transporter.read(
									{
										method: o.N.Get,
										path: (0, s.encode)('1/indexes/%s/synonyms/%s', e.indexName, t),
									},
									r,
								),
							de = (e) => (t, r) =>
								...
								return (
									...
									(0, s.createWaitablePromise)(
										e.transporter.write(
											{
												method: o.N.Post,
												path: (0, s.encode)('1/indexes/%s/rules/batch', e.indexName),
												data: t,
											},
											d,
										),
							...
							Pe = (e) => (t, r) => Ie(e)([t], r),
							Ie = (e) => (t, r) => {
								const { forwardToReplicas: n, replaceExistingSynonyms: i, ...c } =
										r || {},
									d = (0, a.createMappedRequestOptions)(c);
								return (
									n && (d.queryParameters.forwardToReplicas = 1),
					...
					858: (e, t, r) => {
						...
						function f(e, t) {
							if (e.method === s.N.Get || (void 0 === e.data && void 0 === t.data))
								return;
